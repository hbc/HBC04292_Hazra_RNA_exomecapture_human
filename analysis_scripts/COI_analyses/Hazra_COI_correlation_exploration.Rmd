...
```{r}
ggplot(corr_data, aes(x=as.factor(Race.x) , y=z_coi_nat, color=as.factor(CaseControl.x))) + geom_boxplot() + geom_point(alpha=0.5, position = position_jitterdodge()) + ylab("COI") + xlab("Race")

ggplot(corr_data, aes(x=as.factor(Race.x) , y=z_coi_nat)) + geom_boxplot() + geom_point(alpha=0.5) + ylab("COI") + xlab("Race")
...
ggplot(cases, aes(x=as.factor(Endocrine_Therapy.x) , y=z_coi_nat, color=as.factor(Race.x))) + geom_boxplot() + geom_point(alpha=0.5, position = position_jitterdodge()) + ylab("COI") + xlab("Endocrine Therapy")


ggplot(cases, aes(x=as.factor(Grade.x) , y=z_coi_nat, color=as.factor(Race.x))) + geom_boxplot() + geom_point(alpha=0.5, position = position_jitterdodge()) + ylab("COI") + xlab("Grade")

ggplot(cases, aes(x=as.factor(Inv_Dx.x) , y=z_coi_nat, color=as.factor(Race.x))) + geom_boxplot() + geom_point(alpha=0.5, position = position_jitterdodge()) + ylab("COI") + xlab("Inv.dx")

ggplot(cases, aes(x=as.factor(MarginStatus.x) , y=z_coi_nat, color=as.factor(Race.x))) + geom_boxplot() + geom_point(alpha=0.5, position = position_jitterdodge()) + ylab("COI") + xlab("Margin Status")


ggplot(cases, aes(x=as.factor(BRCA1_result.x) , y=z_coi_nat, color=as.factor(Race.x))) + geom_boxplot() + geom_point(alpha=0.5, position = position_jitterdodge()) + ylab("COI") + xlab("Endocrine Therapy") + ylab("COI") + xlab("BRCA1_result")


ggplot(cases, aes(x=as.factor(Radiation_Therapy.x) , y=z_coi_nat, color=as.factor(Race.x))) + geom_boxplot() + geom_point(alpha=0.5, position = position_jitterdodge()) + ylab("COI") + xlab("Radiation Therapy")


ggplot(cases, aes(x=as.factor(Surgery_Type.x) , y=z_coi_nat, color=as.factor(Race.x))) + geom_boxplot() + geom_point(alpha=0.5, position = position_jitterdodge()) + ylab("COI") + xlab("Surgery Type")
